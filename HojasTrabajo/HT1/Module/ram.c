...
{
    init_meminfo();
    seq_printf(archivo, "{\"totalram\": %lu, \"freeram\": %lu}", si.totalram, si.freeram);
    return 0;
}
...
{
    proc_create("ram_201908355", 0, NULL, &operaciones);
    printk(KERN_INFO "201908355\n");
    return 0;
}
...
{
    remove_proc_entry("ram_201908355", NULL);
